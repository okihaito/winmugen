...
trigger1 = 1
text = "AI=%d Alive=%d,var(5)=%d,Life=%d,var(6)=%d"
params = Var(7),Alive,var(5),sysvar(1),var(6)

[State -1, Debug]
type = AppendToClipboard
trigger1 = 1
text = "hitpausetime=%d,P2alive=%d,time=%d,fvar(2)=%d,anim=%d"
params = hitpausetime,(enemy,alive),sysvar(2),fvar(2),var(10)
...
trigger1 = EnemyNear,NumHelper <= 1
trigger1 = P2movetype = A
...
triggerall = (Random = [0,500]) || (Power = [1000,1999])
...
triggerall = NumHelper(1807) = 0
triggerall = Var(7) = 1
triggerall = EnemyNear,NumHelper <= 2
triggerall = statetype != A
triggerall = ctrl
triggerall = EnemyNear,NumProj = 0
...
trigger2 = power >= 1000
trigger2 = anim = 220 || anim = 410 || anim = 440
trigger2 = movehit
...
trigger3 = P2statetype = A
trigger3 = anim = 110
trigger3 = P2Dist X = [-40,60]
trigger3 = P2Dist Y = [-130,0]
trigger3 = random >= 700
trigger3 = EnemyNear,Vel Y >= 6
...
value = 1504
triggerall = var(7) = 1
triggerall = P2StateNo <= 5099
triggerall = P2statetype != L
triggerall = EnemyNear,Vel X = [-3,3]
trigger1 = anim = 220 || anim = 250 || (anim = 240 && P2stateType = A)
trigger1 = movehit
...
trigger2 = var(3) = 0
trigger2 = P2Stateno < 1000
trigger2 = anim = 5120 && time = [4, 9]; ["Wake up" code by SorrowEdge]
trigger2 = P2BodyDist X = [-80,60]
trigger3 = var(3) = 0
trigger3 = NumHelper(1100) = 0
trigger3 = (ctrl && var(9) <= 2) || anim = 110
...
trigger2 = var(3) = 0
trigger2 = P2Stateno < 1000
trigger2 = anim = 5120 && time = [4, 9]
trigger2 = P2BodyDist X = [-80,60]
trigger3 = var(3) = 0
trigger3 = (ctrl && var(9) <= 2) || prevstateno = 100
trigger3 = P2movetype = A || Random < 50
trigger3 = statetype != A
trigger3 = P2BodyDist X = [-30,30]
trigger3 = P2Stateno <= 1999
...
trigger1 = movecontact
trigger1 = P2Dist Y <= 0
trigger2 = anim = 1400 || anim = 610 || anim = 640
trigger2 = movecontact
trigger2 = Pos Y > -20
trigger2 = P2Dist Y <= 0
trigger3 = var(1) = 2
...
trigger12 = stateno = 5120 && time = [4, 9]
...
trigger17 = stateno = 5120 && time = [4, 9]
...
trigger13 = movecontact
trigger13 = stateno = 450
trigger14 = stateno = 5120 && time = [4, 9]
...
triggerall = !time
trigger1 = !((anim = [190, 194]) || anim = 5900)
value = 5900
ignorehitpause = 1
