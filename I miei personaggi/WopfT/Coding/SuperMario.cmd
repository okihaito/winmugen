...
type = Selfstate
triggerall = !time
trigger1 = ishelper(102002)
value = 102002
ignorehitpause = 1

[state -1, 被弾用ステ固定]
type = Selfstate
trigger1 = ishelper(104444)
value = 104444
ignorehitpause = 1
...
triggerall != P2name = "Goku SSJ4"
triggerall != P4name = "Goku SSJ4"
...
triggerall = (P2BodyDist X > 30) && (P2BodyDist X < 100)
